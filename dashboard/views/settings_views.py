...
from dashboard.serializers.settings_serializers import (
    AutomationScheduleSerializer, WiFiConfigSerializer)
...
class WiFiConfigView(APIView):
    ...
    def put(self, request, pond_id):
        ...
        try:
            wifi_config = pond.wifi_config
            serializer = WiFiConfigSerializer(
                wifi_config, data=request.data, partial=True
            )
