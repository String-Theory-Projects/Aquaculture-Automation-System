...
CONTROL_WATER_TOPIC = os.getenv(
    "MQTT_CONTROL_WATER_TOPIC", f"{BASE_TOPIC}/control/water"
)
AUTOMATION_FEED_TOPIC = os.getenv(
    "MQTT_AUTOMATION_FEED_TOPIC", f"{BASE_TOPIC}/automation/feed"
)
AUTOMATION_WATER_TOPIC = os.getenv(
    "MQTT_AUTOMATION_WATER_TOPIC", f"{BASE_TOPIC}/automation/water"
)
...
STATUS_AUTOMATION_TOPIC = os.getenv(
    "MQTT_STATUS_AUTOMATION_TOPIC", f"{BASE_TOPIC}/status/automation"
)
