...
from dashboard.models import AutomationSchedule, Pond, WiFiConfig
...
class BaseSettingsTest(TestCase):
    ...
    def setUp(self):
        ...
        self.pond = Pond.objects.create(
            name="Test Pond", owner=self.user, device_id="TEST001", is_active=True
        )
...
class WiFiConfigViewTest(BaseSettingsTest):
    ...
    def test_create_wifi_config(self):
        ...
        payload = {"ssid": "TestNetwork", "password": "TestPassword123"}
    ...
    def test_get_wifi_config(self):
        ...
        WiFiConfig.objects.create(
            pond=self.pond, ssid="TestNetwork", password="TestPassword123"
        )
    ...
    def test_update_wifi_config(self):
        ...
        wifi_config = WiFiConfig.objects.create(
            pond=self.pond, ssid="OldNetwork", password="OldPassword123"
        )

        payload = {"ssid": "NewNetwork", "password": "NewPassword123"}
...
class AutomationScheduleViewTest(BaseSettingsTest):
    ...
    def setUp(self):
        super().setUp()
        self.schedules_url = reverse(
            "automation_schedules", kwargs={"pond_id": self.pond.id}
        )
...
class AutomationScheduleDetailViewTest(BaseSettingsTest):
    ...
    def setUp(self):
        ...
        self.detail_url = reverse(
            "automation_schedule_detail", kwargs={"schedule_id": self.schedule.id}
        )
    ...
    def test_update_schedule(self):
        ...
        payload = {"feed_amount": 75.0, "days": "1,2,3,4,5,6", "is_active": False}
    ...
    def test_wrong_user_access(self):
        ...
        url = reverse(
            "automation_schedule_detail", kwargs={"schedule_id": other_schedule.id}
        )
        response = self.client.get(url)
